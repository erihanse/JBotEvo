...
public class ThymioTwoWheelActuator extends Actuator {
	...
	@ArgumentsAnnotation(name="maxspeed", defaultValue = "0.2")
	protected double maxSpeed;
	
	public ThymioTwoWheelActuator(Simulator simulator, int id, Arguments arguments) {
		super(simulator, id, arguments);
		this.random = simulator.getRandom();
		this.maxSpeed = arguments.getArgumentAsDoubleOrSetDefault("maxspeed", 0.2);
	}
	...
	public String toString() {
		return "ThymioTwoWheelActuator [leftSpeed=" + leftSpeed + ", rightSpeed="
				+ rightSpeed + "]";
	}
