...
import network.SimulatedBroadcastMessageSender;
...
public class SimulatedThymioBroadcastHandler extends BroadcastHandler {

	private SimulatedBroadcastMessageSender sender;

	public SimulatedThymioBroadcastHandler(RobotCI drone, ArrayList<BroadcastMessage> broadcastMessages) {
