...
public class TurnLeftEvaluationFunction extends EvaluationFunction{

	protected TurnSideEnvironment env;
	protected int steps;

	public TurnLeftEvaluationFunction(Arguments args) {
		super(args);
	...
	public void update(Simulator simulator) {
		...
		if(status == TurnSideEnvironment.TURN_SIDE_RIGHT || r.isInvolvedInCollisonWall()
