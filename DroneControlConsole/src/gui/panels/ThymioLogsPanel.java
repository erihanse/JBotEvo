...
public class ThymioLogsPanel extends JPanel {
	...
	public ThymioLogsPanel(final ThymioGUI thymioGUI) {
		...
		getLogsButton = new JButton("Get Logs From Robots");
		getLogsButton.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				SortedListModel ipsList = thymioGUI.getConnectionPanel().getListModel();
