...
import simulation.physicalobjects.checkers.AllowGroundColoredBandChecker;
...
public abstract class Shape implements Serializable {
	...
	//protected ClosePhysicalObjects closeBands;
	...
	public Shape(Simulator simulator, String name, PhysicalObject parent, 
		...
		//closeBands = new ClosePhysicalObjects(simulator.getEnvironment(), range, new AllowGroundColoredBandChecker());
