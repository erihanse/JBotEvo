...
public class ThymioMotorFaultThreeTwoWheelCINNOutput extends CINNOutput {
	...
	public ThymioMotorFaultThreeTwoWheelCINNOutput(RobotCI robot, CIArguments args) {
		super(robot,args);
		int robotId = ((ThymioCI) robot).getRobotId();
		//fault one motor experiments, robot id = 11
		if(robotId == 11 || robotId == 12 || robotId == 13){
