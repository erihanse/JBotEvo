...
public class Old_CompatibilityCalculator implements Serializable{
	...
	public Old_CompatibilityCalculator(double excessCoef, double disjointCoef, double weightCoef, double compThreshold){
