...
//should be the white area
public class RealThymioInAreaBSensor extends CISensor {
	//public static boolean DEBUG = false;
	private ThymioCI thymio;
	private List<Short> readings;

	private double inAreaB;
	protected final double MIN = 935;
	
	public RealThymioInAreaBSensor(int id, RobotCI robot, CIArguments args) {
		super(id, robot, args);
