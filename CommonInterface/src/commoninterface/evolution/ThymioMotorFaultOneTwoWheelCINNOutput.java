...
public class ThymioMotorFaultOneTwoWheelCINNOutput extends CINNOutput {
	...
	public ThymioMotorFaultOneTwoWheelCINNOutput(RobotCI robot, CIArguments args) {
		super(robot,args);
		...
		if(robotId == 11){
			...
			try {
				BufferedWriter writer = new BufferedWriter(new FileWriter("motor_faults_one.csv", true));
