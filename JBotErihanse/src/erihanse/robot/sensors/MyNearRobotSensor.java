...
public class MyNearRobotSensor extends Sensor {
	...
	public MyNearRobotSensor(Simulator simulator, int id, Robot robot, Arguments args) {
	...
	public double getSensorReading(int sensorNumber) {
		...
		ArrayList<Robot> connected = env.getRobots();
