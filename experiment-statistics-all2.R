homeroute_10robots <- read.table("JBotErihanse/confs/output-all-experiments/homeroute-10robots.txt")
homeroute_15robots <- read.table("JBotErihanse/confs/output-all-experiments/homeroute-15robots.txt")
homeroute_20robots <- read.table("JBotErihanse/confs/output-all-experiments/homeroute-20robots.txt")

random_10robots <- read.table("JBotErihanse/confs/output-all-experiments/random-walk-10robots.txt")
random_15robots <- read.table("JBotErihanse/confs/output-all-experiments/random-walk-15robots.txt")
random_20robots <- read.table("JBotErihanse/confs/output-all-experiments/random-walk-20robots.txt")

odneat_10robots <- read.table("JBotErihanse/confs/output-all-experiments/odneat-10robots.txt")
odneat_15robots <- read.table("JBotErihanse/confs/output-all-experiments/odneat-15robots.txt")
odneat_20robots <- read.table("JBotErihanse/confs/output-all-experiments/odneat-20robots.txt")
...
axis(1, seq(0,10000, 1000), seq(0, 10000, 1000),las=2)
